...
test_dataset = DVS128Gesture(root='/root/autodl-tmp/DVS128/', train=False, data_type='frame', frames_number=8, split_by='number')
...
torch.save(model.state_dict(), './Spike-DrivenV2_DVS128_greedysoup.pkl')
print('合并模型已保存')
